...
const Header = () => {
    ...
    return (
        ...
        <div className="md:px-16 md:py-4 px-4 py-2 flex justify-between items-center border-b-2 border-gray-400 fixed w-full">
            <div>
                <img className="md:w-36 w-24" src ={LOGO_URL} alt="nwxtwatch"/>
            </div>
